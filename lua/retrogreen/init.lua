--[[ require 'retrogreen.highlights' ]]
local utils = require 'retrogreen.utils'
...
function M.setup(opts)
  opts = opts or {}
  -- vim.g.retrogreen_variant = opts.dark_variant or 'main'
...
function M.colorscheme()
  ...
  vim.g.colors_name = 'retrogreen'

  local theme = require('retrogreen.theme').get(config)
